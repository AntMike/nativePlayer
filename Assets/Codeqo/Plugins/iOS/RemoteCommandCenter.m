...
- (NSMutableDictionary*) getMediaItemDictionary {
    ...
    //[trackInfo setObject:[NSNumber numberWithDouble:(double)[[self player] isPlaying] ? 1 : 0] forKey:MPNowPlayingInfoPropertyPlaybackRate];
    //[trackInfo setObject:@(0.0) forKey:MPNowPlayingInfoPropertyDefaultPlaybackRate];
